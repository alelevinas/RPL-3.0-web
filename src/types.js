...
export type Activity = {
  ...
  activity_io_tests: Array<IOTest>,
  date_created: string,
  last_updated: string,
};
...
export type SubmissionResult = {
  ...
  activity_unit_tests_content: string,
  activity_io_tests_input: Array<string>,
  submission_status: string,
  exit_message: string,
  stderr: string,
  stdout: string,
  io_tests_run_results: Array<IOTestRunResult>,
  unit_tests_run_results: Array<UnitTestRunResult>,
